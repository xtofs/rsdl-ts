...
const model = new rsdl.Model(
  ...
  [
    new rsdl.ModelCapability(new ModelPath("OrderItem"), {}, new rsdl.PatchCapability()),
    new rsdl.ModelCapability(new ModelPath("Order::items"), { cardinality: rsdl.Cardinality.Multiple }, new rsdl.PatchCapability()),
    new rsdl.ServiceCapability(new ServicePath("/orders/{id}/items/{id}/product"), {}, new rsdl.PatchCapability()),
  ]
);
...
const text = Deno.readTextFileSync("./example.rsdl");
